    ...
    const styles = reactive({
      toggler: computed(
        () => css`
          ...
          background: ${theme.value.colors.underBackground};
          ...
          &:focus {
            --ball-border: 2px solid ${theme.value.colors.focusColor};

            border-color: ${theme.value.colors.focusColor};
            outline: none;
          }
      ...
      togglerBall: computed(
        () => css`
          background: ${theme.value.colors.overBackground};
